...
namespace RayTracer {
	...
	void Scene::TwoSpheresInCornellBox()
	{
		...
		sceneObjects.push_back(new Sphere3d(Point3d(-1, -2, 8), 1, shadersWhiteSpecular,	 Material(0.0f, 0.9f, 1.0f)));
		sceneObjects.push_back(new Sphere3d(Point3d(2, -1, 9), 2, shadersWhiteSpecular,		Material(0.0f, 0.9f, 1.04f)));
	}
